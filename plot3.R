...
#CREATING PLOT 3
#Plot 3 is a line connected time-series plot of the three Sub_metering variables with the x-axis only showing days of the week.
...
#Appending Sub_metering_2 data
with(hpc.data, lines(y=Sub_metering_2, x=datetime, col="#ff2500"))

#Appending Sub_metering_3 data
with(hpc.data, lines(y=Sub_metering_3, x=datetime, col="#0230ff"))

#Adding legend
legend("topright", c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"), col=c("black", "#ff2500", "blue"), lty=1)
